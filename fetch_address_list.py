"""Fetch every address across all pages from LogiNext ClientApp/clientnode/get.

Mirrors references/curls/fetch_address_list.sh. Set LGNX_AUTH_TOKEN in .env
(the value after `BASIC ` in the curl's www-authenticate header).

Usage:
    uv run python fetch_address_list.py [--page-size 50] [--delay 1.0] [--out exports/addresses.xlsx]
"""
